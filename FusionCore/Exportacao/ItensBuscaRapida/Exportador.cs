...
namespace FusionCore.Exportacao.ItensBuscaRapida
{
    public class Exportador
    {
        ...
        public void Exportar(ILayoutBuscaRapida layout, IEnumerable<string> arquivosDestino)
        {
        ...
        private IEnumerable<Linha> BuscaItensExportacao()
        {
            using (var sessao = _sessaoManager.CriaStatelessSession())
            {
                var repositorio = new RepositorioBuscaRapida(sessao);
