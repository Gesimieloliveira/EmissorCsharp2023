...
create view  [dbo].[view_vendas_com_itens] as
select all
    v.*,
    nfvi.id as item_id,
...
select all
	...
	cast((ncvi.valorUnitario*ncvi.quantidade-ncvi.desconto-ncvi.descontoAlteraItem + ncvi.acrescimo) as decimal(15,2)) as itemTotal,
