...
{
    public class RDanfeNfce : RelatorioBase, IRDanfeNfce
    {
        ...
        public RDanfeNfce() : base(null)
        {
        }

        protected override byte[] FornecerTemplate()
        {
            return FornecedorTemplate.ObtemBytesFrx("FrDanfeNfce.frx");
        }
        ...
        public void ForcarSegundaVia(bool segundaVia)
        {
            _forcarSegundaVia = segundaVia;
        }
