...
{
    public class SalvarVeiculoReboqueEventArgs : EventArgs
    {
        public SalvarVeiculoReboqueEventArgs(FlyoutAddVeiculoReboqueModel model)
        {
            Model = model;
        }

        public FlyoutAddVeiculoReboqueModel Model { get; set; }
    }

    public class FlyoutAddVeiculoReboqueModel : ViewModel
    {
        ...
        {
            get => _tipoPropriedadeVeiculo;
            set
            {
                if (value == _tipoPropriedadeVeiculo)
                {
                    return;
                }
        ...
        public event EventHandler<SalvarVeiculoReboqueEventArgs> SalvarVeiculoReboqueHandler;
        ...
        public void SalvarVeiculoReboque()
        {
            Validar();
            OnSalvarVeiculoReboqueHandler();
            LimparCampos();
        }
        ...
        private void Validar()
        {
            if (Veiculo == null)
            {
                throw new ArgumentException("Adicionar um veículo");
            }
        }

        protected virtual void OnSalvarVeiculoReboqueHandler()
        {
            SalvarVeiculoReboqueHandler?.Invoke(this, new SalvarVeiculoReboqueEventArgs(this));
        }
    }
}