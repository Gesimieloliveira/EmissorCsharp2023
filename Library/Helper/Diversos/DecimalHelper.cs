...
namespace FusionLibrary.Helper.Diversos
{
    ...
    {
        public static decimal? ConverteFrom(string value)
        {
            return decimal.TryParse(value, out var parsed)  ? parsed  : default(decimal?);
        }
        ...
        // O método EscreverExtenso recebe um valor do tipo decimal by: algum site qualquer da net
