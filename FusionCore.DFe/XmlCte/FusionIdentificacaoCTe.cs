...
namespace FusionCore.DFe.XmlCte
{
    ...
    public class FusionIdentificacaoCTe
    {
        ...
        public bool ProxyGlobalizadoSpecified => ProxyGlobalizado.HasValue;

        [XmlElement(ElementName = "indGlobalizado")]
        public int? ProxyGlobalizado
        {
            get => Globalizado ? 1 : (int?) null;
            set => Globalizado = value > 0;
        }
        ...
        public FusionIndicadorIcmsTomador FusionIndicadorIcmsTomador { get; set; }

        [XmlElement(ElementName = "toma3")]
